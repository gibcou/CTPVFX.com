    ...
    <>
      ...
      <nav id="main-nav">
        ...
        <ul className={`nav-links${navOpen ? ' open' : ''}`}>
          <li><a href="#why" onClick={() => setNavOpen(false)}>Approach</a></li>
          <li><a href="#services" onClick={() => setNavOpen(false)}>Services</a></li>
          <li><a href="#projects" onClick={() => setNavOpen(false)}>Projects</a></li>
          <li><a href="#contact" className="nav-cta" onClick={() => setNavOpen(false)}>Get a quote</a></li>
        </ul>
        <button className={`hamburger${navOpen ? ' open' : ''}`} onClick={() => setNavOpen(v => !v)} aria-label="Toggle navigation">
      ...
      <section className="why">
        <div className="why-inner">
          ...
          <div className="why-grid stagger">
            <div className="why-card"><div className="why-num">01</div><span className="why-icon"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="2"/><line x1="7" y1="2" x2="7" y2="22"/><line x1="17" y1="2" x2="17" y2="22"/><line x1="2" y1="12" x2="22" y2="12"/><line x1="2" y1="7" x2="7" y2="7"/><line x1="17" y1="7" x2="22" y2="7"/><line x1="17" y1="17" x2="22" y2="17"/><line x1="2" y1="17" x2="7" y2="17"/></svg></span><h3>We speak VFX</h3><p>Showreels, shot breakdowns, credit pages, Vimeo embeds — we know the vocabulary and the craft.</p></div>
            <div className="why-card"><div className="why-num">02</div><span className="why-icon"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg></span><h3>We move fast</h3><p>14 days from kickoff to a live, polished MVP. VFX runs on tight deadlines. Your website build should too.</p></div>
            <div className="why-card"><div className="why-num">03</div><span className="why-icon"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="17 1 21 5 17 9"/><path d="M3 11V9a4 4 0 0 1 4-4h14"/><polyline points="7 23 3 19 7 15"/><path d="M21 13v2a4 4 0 0 1-4 4H3"/></svg></span><h3>We stay on</h3><p>Our retainer keeps your site alive. New reel? New credit? We handle it. You focus on production.</p></div>
            <div className="why-card"><div className="why-num">04</div><span className="why-icon"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg></span><h3>Flat pricing</h3><p>$10k build. $5k/mo retainer. You know the full cost before we start. No surprise invoices.</p></div>
          </div>
        </div>
      </section>
